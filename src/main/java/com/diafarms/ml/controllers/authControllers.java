...
public class authControllers {
  ...
  @PostMapping("/auth")
    public ResponseEntity<ApiResponse<Object>> auth(String grantType, String email, String password, boolean ouiRefresh, String refreshToken){
        try {
            // Réponse réussie
            return ApiResponse.createResponse("Opération réussie", HttpStatus.OK, serives.jwt(grantType, email, password, ouiRefresh, refreshToken), null);
